...
boord van het lichtschip [West-Hinder 3]({% include url.html slug='on9bd' lang='nl' %}{{ page_url }}).
...
terug op de [startpagina]({% include url.html slug='home' lang='nl' %}{{ page_url }}#vergaderen). Vragen? Neem
